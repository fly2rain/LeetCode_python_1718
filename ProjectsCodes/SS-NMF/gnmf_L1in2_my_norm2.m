function [U, V, objErrs] = gnmf_L1in2_norm2(X, U, V, W, varargin)
...
[errTol, maxIter, lambda, alpha, normType, normW, verb, epss] = parse_opt(varargin, ...
         'errTol', 1e-4, 'maxIter', 200, 'lambda', 1, 'alpha', 0.5, ...
         'normType', 2, 'normW', 1, 'verb', 10, 'myeps', []);
