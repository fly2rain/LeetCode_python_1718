function [U, V, objErrs] = gnmf_sc_Multi_2(X, varargin)
% -- function [U, V, objErrs] = gnmf_sc_Multi_2(X, varargin)
...
[errTol, maxIter, lambda, alpha, normType, normW, verb, U, V, epss, W] = parse_opt(varargin, ...
               'errTol', 1e-4, 'maxIter', 200, 'lambda', 1, 'alpha', 0.5, ...
               'normType', 1, 'normW_orNot', 1, 'verb', 10,  ...
               'W0', [], 'H0^T', [] , 'myeps', [], 'WeightMatrix', []);
