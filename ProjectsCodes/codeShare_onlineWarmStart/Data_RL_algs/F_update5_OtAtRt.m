function [OtN,AtN,RtN,GotN] = F_update5_OtAtRt (OtN,AtN,beta,...
...
if t ~= 1
    OtN = F_simuStat5 (OtN, AtN, beta, nseSt);
end
...
%% % simulate the states %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function OtN = F_simuStat5 (O0N, AtN, beta, nseSt)
% Breif:
...
if nargin < 3 % default parameter in beta
    beta = [0.4,0.25,0.8,0.5,0.05,0.5,0.25,10,0.25,0.25,0.4,0.1,0.9, 0, 0, 0, 0].';
end
