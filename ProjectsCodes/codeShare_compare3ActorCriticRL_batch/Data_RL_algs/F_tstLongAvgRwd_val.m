function [longRwd, GrQtErr, avgLongRwd, stdLongRwd] = F_tstLongAvgRwd_val (O0N, thetaN, vtN, varargin)
% Breif:
...
%     [1]
%
% versuin 4.1 -- 01/05/2015
% version 3.0 -- 12/10/2015
% version 2.0 -- 12/02/2015
% version 1.0 -- 10/14/2015
%
% Written by Feiyun Zhu (fyzhu0915@gmail.com)
[datIdx,TT,T0,tau,alpha,md,nseRwd,nseSt,beta,gamma,RBFbnd] = parse_opt (varargin, ...
    'datIdx',2,'EndTime',10^4,'StarTime',10^3,'tau',0.4,'alpha',1,...
    'mydim',[],'nseRwd',1,'nseSt',0.1,'beta',[],'gamma',0,'RBFbnd',1);
