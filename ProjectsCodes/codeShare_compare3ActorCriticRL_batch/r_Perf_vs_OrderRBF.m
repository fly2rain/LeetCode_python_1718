...
GrOrder = [2, 3, 4, 5];   NOrder = length (GrOrder);
...
% zetaC=0.05; order=1; FoChoice='RBF';
...
rstName = [dirName 'PvsOrderRBF AI-Batch datIdx=' num2str(datIdx) ' nbeta=' num2str(nbeta) ...
